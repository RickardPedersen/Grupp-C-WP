...
?>
            ...
            <?php $homepageObjects = new WP_Query(array(
                "posts_per_page" => 4,
    ...
    <div class="object-summary d-flex row">
        ...
        <div class="objects-summary__content shadow m-2" style="background-image:url('<?php get_the_post_thumbnail_url($homepageObjects) ?>')">
            ...
            <div class="row pl-4">
                ...
                <?php the_title() ?></a></h5>
                <p class=" pl-4 pb-4 pr-4"><?php echo wp_trim_words(get_the_content(), 35);?> <a class="text-primary" href="<?php the_permalink(); ?>" class="text-light"
        >Läs mer</a></p>
        </div>
    </div>
