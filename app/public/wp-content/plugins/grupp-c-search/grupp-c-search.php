 ...
 * Description: Search widget for real estate page.
 * Version: 1.0.0
 * Author: Grupp C
...
?>
		...
		<form method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>" role="search">
			...
			<div>
			<input class="field form-control" id="s" name="s" type="text" placeholder="Sök efter ort, etiketter, mm ..." value="<?php the_search_query(); ?>">
				<h5>Antal rum</h5>
				<label>
					Min: 
